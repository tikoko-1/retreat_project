...
import { ArrowRight, User, Clock, ChevronLeft, ChevronRight, Check, AlertCircle } from "lucide-react";
    ...
    <form onSubmit={handleSubmit} className="space-y-4 max-w-md mx-auto">
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Button 
          type="submit"
          disabled={isSubmitting}
          className="bg-white text-gray-900 hover:bg-gray-100 disabled:bg-gray-300 disabled:cursor-not-allowed px-6 py-3 rounded-lg h-auto transition-colors"
        >
...
export default function BlogPage({ onNavigateToBlogPost, onNavigateToHostPortal }: BlogPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* CTA Section */}
      <CallToActionSection onNavigateToHostPortal={onNavigateToHostPortal} />
    </div>
  );
}