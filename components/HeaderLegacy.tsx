...
import { Dialog, DialogContentWithoutCloseButton, DialogHeader, DialogTitle, DialogDescription } from "./ui/dialog";
  ...
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Sheet open={showMobileMenu} onOpenChange={setShowMobileMenu}>
              ...
              <SheetContent side="right" className="w-full sm:w-96 bg-white p-0 border-none shadow-2xl [&>button]:hidden">
                {/* Premium Header */}
                  ...
                  <div className="flex items-center justify-between p-8">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">Premium Retreat Network</p>
                      </div>
                    </div>
                ...
                <div className="flex flex-col h-full overflow-y-auto">
                  ...
                  <div className="px-8 py-8">
                    <div className="mb-6">
                      <h4 className="text-xs font-bold text-gray-500 uppercase tracking-[0.1em] mb-1">For Business</h4>
                      <p className="text-xs text-gray-400">Grow your retreat business</p>
                    </div>
                    <div className="space-y-2">
                      <button 
                        onClick={() => {
                      ...
                      >
                        ...
                        <div>
                          <span className="font-semibold text-base">List Your Center</span>
                          <p className="text-xs text-white/70 mt-0.5">Start earning today</p>
                        </div>
                      </button>
                  ...
                  <div className="px-8 py-8">
                    <div className="mb-6">
                      <h4 className="text-xs font-bold text-gray-500 uppercase tracking-[0.1em] mb-1">Support</h4>
                    ...
                    <div className="space-y-1">
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 mt-0.5">hello@retreatcenters.com</p>
                        </div>
                      </a>
                      <a 
                      ...
                      >
                        ...
                        <div>
                          <span className="font-medium text-sm">Phone Support</span>
                          <p className="text-xs text-gray-500 mt-0.5">+1 (555) 123-4567</p>
                        </div>
                      </a>
                    </div>
                  </div>
    ...
    <Dialog open={showSearchModal} onOpenChange={setShowSearchModal}>
      <DialogContentWithoutCloseButton
        className="!max-w-none !w-[95vw] sm:!w-[85vw] md:!w-[70vw] lg:!w-[50vw] xl:!w-[32vw] h-[80vh] sm:h-[70vh] md:h-[65vh] lg:h-[57vh] p-0 flex flex-col rounded-xl border border-gray-200 shadow-xl"
      >
          ...
          <DialogHeader className="px-6 py-5 border-b border-gray-100 bg-white relative rounded-t-xl !text-left">
            <div className="flex items-center justify-between">
              <div className="text-left">
                <DialogTitle className="text-2xl font-semibold text-gray-900 text-left">Find Your Perfect Retreat Center</DialogTitle>
