...
const featuredGuides = [
  {
    ...
    excerpt:
      "Discover authentic yoga and meditation experiences in Bali's most sacred and beautiful retreat centers.",
    imageUrl:
      "https://images.unsplash.com/photo-1670293797043-2c0788c5a7be?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiYWxpJTIwdGVtcGxlJTIwcmljZSUyMHRlcnJhY2VzfGVufDF8fHx8MTc1NTk4NDExM3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    region: "Asia",
  ...
  },
  {
    ...
    excerpt:
      "Explore eco-conscious wellness destinations nestled in Costa Rica's pristine rainforests and beaches.",
    imageUrl:
  ...
  },
  {
    ...
    excerpt:
      "Find profound inner peace at Mexico's most transformative meditation retreat centers and sacred spaces.",
    imageUrl:
  ...
  },
  {
    ...
    excerpt:
      "Experience authentic yoga traditions and ancient wisdom at India's most revered spiritual destinations.",
    imageUrl:
      "https://images.unsplash.com/photo-1726266140662-9c9ff46bfdc8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmRpYSUyMHRlbXBsZSUyMHNwaXJpdHVhbHxlbnwxfHx8fDE3NTU5NTk4NTV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    region: "Asia",
  ...
  },
  {
    ...
    excerpt:
      "Indulge in sophisticated wellness experiences along Portugal's stunning coastline and countryside.",
    imageUrl:
      "https://images.unsplash.com/photo-1690894788605-659becd7f809?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwb3J0dWdhbCUyMG5hdHVyZSUyMGxhbmRzY2FwZXxlbnwxfHx8fDE3NTU5NTk4NjZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    region: "Europe",
  ...
  },
  {
    ...
    excerpt:
      "Embrace sustainable luxury and natural healing in Thailand's most pristine island and jungle settings.",
    imageUrl:
      "https://images.unsplash.com/photo-1716157328257-aa7d6826fc3e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0aGFpbGFuZCUyMG5hdHVyZSUyMGxhbmRzY2FwZXxlbnwxfHx8fDE3NTU5NTk4NTh8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    region: "Asia",
    readTime: "9 min read",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-xl lg:text-2xl text-gray-600 leading-relaxed">
              Discover the world's best yoga and wellness retreat destinations,
              carefully curated for transformational experiences.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto">
                Join thousands of wellness facilitators connecting with retreat
                organizers worldwide and showcase your unique space.
              </p>
            </div>
