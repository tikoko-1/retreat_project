...
export default function DashboardOverview({ onNavigate }: DashboardOverviewProps) {
  return (
    <div className="p-6 lg:p-8">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl lg:text-4xl font-light mb-2">Welcome back, Maya</h1>
        <p className="text-gray-600">Here's what's happening with your retreat center today.</p>
      </div>
        ...
        {statsCards.map((card, index) => {
          ...
          return (
            <div key={index} className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div className="mb-2">
                <h3 className="text-2xl font-light text-gray-900">{card.value}</h3>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              {upcomingRetreats.map((retreat) => (
                <div key={retreat.id} className="flex items-center justify-between p-4 border border-gray-100 rounded-lg hover:border-gray-200 transition-colors">
                  <div className="flex-1">
                    <h3 className="font-medium text-gray-900 mb-1">{retreat.title}</h3>
                  ...
                  <div className="flex items-center gap-3">
                    <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                      retreat.statusColor === 'green' ? 'bg-green-100 text-green-700' :
                      retreat.statusColor === 'orange' ? 'bg-orange-100 text-orange-700' :
                ...
                return (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                      ...
                      <Icon className={`w-5 h-5 ${action.primary ? 'text-white' : 'text-gray-600'}`} />
                    </div>
                    <div>
                      <h3 className={`font-medium ${action.primary ? 'text-white' : 'text-gray-900'}`}>
                        {action.title}
                      </h3>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <span className="text-gray-600">New booking from Lisa Rodriguez</span>
                  <span className="text-gray-400 ml-auto">2h ago</span>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-gray-600">Inquiry received for April dates</span>
                  <span className="text-gray-400 ml-auto">4h ago</span>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                  <span className="text-gray-600">Payment pending for March retreat</span>
