...
const coreAmenities = [
  {
    ...
    title: "Dedicated Yoga Shala",
    subtitle: "1,200 sq ft with acoustic design\\nPanoramic jungle views",
  },
  {
    icon: <Utensils className="w-5 h-5" />,
    title: "Organic Meals",
    subtitle: "Vegan/vegetarian options\\nCustomized dietary accommodations",
  },
  {
    icon: <Volume2 className="w-5 h-5" />,
    title: "Professional AV",
    subtitle: "Sound system & projectors\\nWorkshop-ready equipment",
  },
  {
    icon: <Wifi className="w-5 h-5" />,
    title: "High‑speed Fiber Wi‑Fi",
    subtitle: "Reliable throughout property\\nPerfect for virtual sessions",
  },
  {
    icon: <Shield className="w-5 h-5" />,
    title: "24/7 On‑site Support & Security",
    subtitle: "Dedicated staff team\\nGated property with medical support",
  },
  {
    icon: <MapPin className="w-5 h-5" />,
    title: "Prime Location",
    subtitle: "5 min to Ubud center\\nEasy airport access (75 min)",
  },
];
...
const extraAmenities = [
  ...
  },
  {
    ...
    subtitle: "Modern gym equipment\\Floor-to-ceiling jungle views",
  },
  {
    icon: <Car className="w-5 h-5" />,
    title: "Free Parking",
    subtitle: "Secure covered parking spaces\\24/7 gated property access",
  },
  {
    icon: <Bike className="w-5 h-5" />,
    title: "Bike Rental",
    subtitle:
      "Complimentary high-quality bicycles\\Perfect for exploring Ubud's rice terraces",
  },
  {
    icon: <Plane className="w-5 h-5" />,
    title: "Airport Transfer",
    subtitle:
      "Professional transportation service\\Direct shuttle from Ngurah Rai Airport",
  },
];
