        ...
        <div className="block lg:hidden">
          <div className="grid grid-cols-2 gap-1">
            {heroImages.slice(0, 4).map((image, index) => (
              <div
                key={index}
                className="aspect-square min-[600px]:aspect-[2/1] relative group cursor-pointer"
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="grid gap-12">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        Protected payments and professional agreements
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-medium">
                        Save 50+ hours of planning
                      </div>
                      <div className="text-sm text-gray-600">
                        Full-service support from booking to checkout
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-medium">
                        Verified by real retreat leaders
                      </div>
                      <div className="text-sm text-gray-600">
                        Trusted by 200+ successful facilitators
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        Streamlined rebooking for returning groups
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid gap-8 text-gray-700 leading-relaxed">
                <p className="text-lg">
                  Our tranquil sanctuary in the heart of Ubud combines ancient
                  Balinese traditions with modern wellness facilities. Designed
                  specifically for facilitators, we provide professional-grade
                  infrastructure while you focus on what matters most — your
                  participants.
                </p>

                <p>
                  The 1,200 sq ft yoga shala features acoustics designed for
                  sound healing, professional AV systems, and panoramic jungle
                  views. Our 25 private suites combine traditional architecture
                  with contemporary comfort, ensuring your group feels both
                  grounded and luxurious.
                </p>

                <p>
                  With 25 years of hosting successful retreats, our dedicated
                  team handles every logistical detail. From airport transfers
                  to customized organic meals, we provide seamless support so
                  you can focus entirely on delivering transformational
                  experiences.
                </p>
              </div>
              ...
              <div>
                <Button
                  variant="outline"
                  className="border-gray-300 hover:bg-gray-50 px-8 py-3 rounded-lg"
                >
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              ...
              <div
                className="bg-white border border-gray-200 rounded-xl p-8 mb-6 shadow-sm"
              ...
              <div className="bg-gray-50 rounded-xl p-6 mt-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Our retreat specialists can help you customize the perfect
