...
export const metadata: Metadata = {
  title:
    "Retreat Centers Platform - Premium B2B Platform for Yoga Teachers & Coaches",
  description:
    "Discover premium retreat centers and venues for yoga teachers, coaches, and retreat organizers. Find the perfect space for your transformational programs.",
  keywords:
    "retreat centers, yoga retreats, wellness venues, meditation centers, spiritual retreats",
  icons: {
    icon:
